...
const authorizeRequest = async (req, res, next) => {
    ...
    try {
      ...
      const requiredPermissions = permissionMap.get(`${method.toUpperCase()} ${parsedUrl}`);
  
      // checking if bearer has required system permissions to proceed
      const isBearerAuthorized = requiredPermissions.some(permission => bearerPermissions.includes(permission));
